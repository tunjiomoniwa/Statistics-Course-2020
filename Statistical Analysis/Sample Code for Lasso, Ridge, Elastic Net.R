...
plot(ROCRperf.tr.ridge,colorize=TRUE, print.cutoffs.at=seq(0,1,by=0.1), main = "ROC-Ridge Regression model",text.adj=c(-0.2,1.7))
...
plot(cutoffs, accuracy, pch =19,type='l',col= "steelblue",
     main ="Ridge Regression", xlab="Cutoff Level", ylab = "Accuracy %")
